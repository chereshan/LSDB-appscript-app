...
// ==========================================================
// почему-то через ui не зписываются свойства, поэтому написал для этого брутфорс-функцию
// ==========================================================
function writeToProperty(property,value){
...
function readFromProperty(property){
  try {
    ...
    try {
      return JSON.parse(value); // Try parsing as JSON first
    } catch (e) {
      return value; // If parsing fails, return raw string value
    }
  }
  catch (e){
    return undefined
...
// ==========================================================
function Z (){
  writeToProperty('SUPABASE_CONFIG', SUPABASE_CONFIG)
  console.log(readFromProperty('SUPABASE_CONFIG'))
}