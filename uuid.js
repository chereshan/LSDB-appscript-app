...
function testGenerateUUIDv5() {
  const myString = 'YWRCT21SN0ZENXd5UzA2Vw';
  const namespaceUUID = '5d063008-14c5-4b96-8b74-8e959827df60';
  const uuidV5 = generateUUIDv5(myString, namespaceUUID);
